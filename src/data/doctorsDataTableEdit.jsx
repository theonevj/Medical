        ...
        renderCell: (params) => (
            <div className="flex gap-3 items-center w-full h-full">
                {params.row?.approvalStatus === 'Approved' ? (
                    ...
                    <>
                        <button
                            onClick={() => handleStatusChange(params.row, 'approve')}
                            className="bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded-md text-sm"
                        >
                            Accept
                        </button>
                        <button
                            onClick={() => handleStatusChange(params.row, 'reject')}
...
const handleStatusChange = async (doctor, status, handleUpdateLocalStatus) => {
    try {
