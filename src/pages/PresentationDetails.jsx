...
const initialData = {
    Ortho: [
        { id: 1, name: "Orthopedics or Orthopaedic (Ortho) ", url: "https://www.canva.com/design/DAG5_q03kPQ/p1IRISmSe6Th5R6VQ3eduA/edit" },
        { id: 2, name: "Cerebral Palsy (CP)", url: "https://www.canva.com/design/DAG5_q03kPQ/p1IRISmSe6Th5R6VQ3eduA/edit" },
        { id: 3, name: "Gynecology (GYN)", url: "https://www.canva.com/design/DAG5_q03kPQ/p1IRISmSe6Th5R6VQ3eduA/edit" },

    ],
    // Radio: [
    //     { id: 2, name: "Cerebral Palsy", url: "https://www.canva.com/design/DAG5_q03kPQ/p1IRISmSe6Th5R6VQ3eduA/edit" },
    // ],
    // Neurologist: [
    //     { id: 3, name: "Gynecology", url: "https://www.canva.com/design/DAG5_q03kPQ/p1IRISmSe6Th5R6VQ3eduA/edit" },
    // ],
};

const PresentationDetails = () => {
    const [data] = useState(initialData); // no need to update data now
    const [type, setType] = useState(Object.keys(initialData)[0]);
            ...
            <div className="bg-white rounded-xl shadow divide-y">
              ...
              cursor-pointer`}
                    >
                        ...
                        <div className="flex gap-4 text-sm">
                            <span className="text-blue-600">Open Canva</span>
                        </div>
                    </div>
                ))}
            </div>
